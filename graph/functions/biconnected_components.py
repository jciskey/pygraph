...
def find_biconnected_components(graph, alter_in_place=False):
    ...
    for component in components:
        #--Call the internal biconnnected components function to find the edge lists for this particular connected component
...
def _internal_get_biconnected_components_edge_lists(graph):
    ...
    Returns a single nested list with 1 edge if there is only 1 edge in the graph (a 2-node graph is a special case, generally considered to be a biconnected graph).
